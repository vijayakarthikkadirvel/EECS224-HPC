...
2. Results - this folder has results what we got for various datasets. In the folder "seq_BC_8846" file means the file has Betweenness Centrality values for the sequential code of dataset of 8846 vertices. In the folder "par_BC_8846" means the file has Betweenness Centrality values for the parallel code of dataset 8846 vertices.
